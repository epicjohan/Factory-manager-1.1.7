                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="number" step="0.01" className="w-full pl-10 p-3 rounded-[2rem] border border-green-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-lg font-black outline-none focus:border-green-500 shadow-sm" value={resolveCost} onChange={e => setResolveCost(parseFloat(e.target.value))} />
                        </div>
                    </div>
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input type="number" className="w-full pl-10 p-3 rounded-[2rem] border border-green-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-lg font-black outline-none focus:border-green-500 shadow-sm" value={resolveTime} onChange={e => setResolveTime(parseInt(e.target.value))} />
                        </div>
                    </div>
                </div>
                <div className="bg-white dark:bg-slate-800 p-4 rounded-[2rem] border border-green-100 dark:border-green-900 flex justify-between items-center text-xs font-black text-slate-500 uppercase tracking-widest shadow-inner">
