  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
      <div className="flex flex-col md:flex-row gap-4 items-center justify-between bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm">
          <div className="relative w-full md:w-80">
              ...
              <input 
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-sm outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                value={searchTerm}
              ...
              <div className="flex justify-between items-center mb-8 border-b border-slate-50 dark:border-slate-700 pb-4">
                  <div className="flex items-center gap-4 text-left">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Koppel reserveonderdelen aan dit asset.</p>
                      </div>
                  </div>
                  <button onClick={() => setShowForm(false)} className="p-3 bg-slate-100 dark:bg-slate-700 rounded-full text-slate-400 transition-colors">
                      <X size={24} />
                  </button>
              </div>
      ...
      <div className="flex justify-end pt-4">
          <div className="bg-slate-900 text-white px-6 py-3 rounded-2xl shadow-xl flex items-center gap-6 border border-white/10">
