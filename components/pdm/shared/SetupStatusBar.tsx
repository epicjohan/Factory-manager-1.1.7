 ...
 * Inclusief de vrijgave-bevestigingsmodal.
 */

import React, { useState } from 'react';
import { SetupStatus, SetupVariant } from '../../../types';
import { AlertTriangle, ChevronDown, ChevronRight, GitBranch, History, Lock, ShieldCheck } from '../../../icons';
...
export const SetupStatusBar: React.FC<SetupStatusBarProps> = ({
    setup, canManage, onChangeStatus, onRevision
}) => {
        ...
        <>
            <div className={`px-6 py-3 flex items-center justify-between border-b ${isDraft ? 'bg-orange-50/50 border-orange-100 dark:bg-orange-900/10 dark:border-orange-900' :
                ...
                <div className="flex gap-2">
                    {isDraft && (
                        <button
                            onClick={() => onChangeStatus(SetupStatus.REVIEW)}
