...
const PERMISSION_GROUPS = [
    ...
    {
        label: 'PDM & Artikelen',
        permissions: [Permission.PDM_VIEW, Permission.PDM_CREATE, Permission.PDM_EDIT_OWN, Permission.PDM_EDIT_ALL, Permission.PDM_RELEASE, Permission.PDM_MANAGE_LOCK, Permission.PDM_ADD_PROCESS]
    },
    {
...
export const UserManagement: React.FC = () => {
    ...
    const handleSaveUser = async (e: React.FormEvent) => {
        ...
        if (duplicate) { addNotification('WARNING', 'Let op', "Pincode in gebruik"); return; }
