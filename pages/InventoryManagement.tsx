...
export const InventoryManagement: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto pb-10 space-y-6 text-left">
       <div>
            ...
            <div className="flex bg-slate-100 dark:bg-slate-800 p-1 rounded-2xl border border-slate-200 dark:border-slate-700 w-fit">
                <button 
                    ...
                    className={`px-6 py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest transition-all flex items-center gap-2 ${activeTab === 'EQUIPMENT' ? 'bg-white dark:bg-slate-700 text-blue-600 shadow-md' : 'text-slate-500 hover:text-slate-800'}`}
                >
                    <Wrench size={16} /> Apparatuur
                </button>
                <button 
                    onClick={() => setActiveTab('STOCK')}
                    className={`px-6 py-2.5 rounded-xl font-bold text-xs uppercase tracking-widest transition-all flex items-center gap-2 ${activeTab === 'STOCK' ? 'bg-white dark:bg-slate-700 text-blue-600 shadow-md' : 'text-slate-500 hover:text-slate-800'}`}
                >
       ...
       <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            {activeTab === 'STOCK' && (
                <button 
                    ...
                    className="flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-2xl font-black uppercase text-xs tracking-widest transition-all shadow-lg shadow-blue-500/20 w-full md:w-auto justify-center"
                >
       ...
       {activeTab === 'STOCK' && (
           <div className="space-y-6">
               <div className="bg-slate-900 text-white p-4 px-6 rounded-2xl shadow-xl flex items-center gap-4 w-fit ml-auto border border-white/10">
                                    ...
                                    <tr key={part.id} className={`hover:bg-slate-50 dark:hover:bg-blue-900/5 group transition-colors ${lowStock ? 'bg-red-50/10' : ''}`}>
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex flex-col items-center gap-1">
                                                <span className={`px-4 py-1.5 rounded-xl text-xs font-black min-w-[5rem] text-center shadow-inner border-2 transition-all ${lowStock ? 'bg-red-600 border-red-500 text-white animate-pulse' : 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20'}`}>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            <div className="flex justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                <button 
                                                    ...
                                                    className="p-2.5 bg-slate-50 dark:bg-slate-700 rounded-xl text-slate-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-all"
                                                    title="Bewerken"
                                                >
                                                    <Edit size={18} />
                                                </button>
                                                <button 
                                                    ...
                                                    className="p-2.5 bg-slate-50 dark:bg-slate-700 rounded-xl text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/30 transition-all"
                                                    title="Verwijderen"
                                                >
                                                    <Trash2 size={18} />
                                                </button>
                   ...
                   <form onSubmit={handleSave} className="space-y-8">
                       <div className="space-y-2">
                           ...
                           <input 
                               required
                               type="text" 
                               className="w-full p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 dark:text-white font-bold outline-none focus:ring-2 focus:ring-blue-500 transition-all"
                       ...
                       <div className="grid grid-cols-2 gap-6">
                           <div className="space-y-2">
                               ...
                               <input 
                                   required
                                   type="text" 
                                   className="w-full p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 dark:text-white font-mono font-black outline-none focus:ring-2 focus:ring-blue-500 transition-all uppercase"
                       ...
                       <div className="grid grid-cols-2 gap-6">
                           <div className="space-y-2">
                               ...
                               <input 
                                   type="text"
                                   className="w-full p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 dark:text-white font-black outline-none focus:ring-2 focus:ring-blue-500 transition-all uppercase"
                           ...
                           <div className="space-y-2">
                               ...
                               <input 
                                   type="number"
                                   step="0.01" 
                                   className="w-full p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 dark:text-white font-mono font-black outline-none focus:ring-2 focus:ring-blue-500 transition-all"
