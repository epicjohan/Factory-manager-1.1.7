...
import { AppState, NotificationTrigger, CommercialModule, LicenseStatus, SystemStatus, SystemAuditLog, EnergyQuarterlyLog, AssetEnergyConfig, EnergyHistoricalLog, Article, PredefinedOperation, SetupTemplate, UserRoleDefinition } from '../types';
...
export const getStore = async (): Promise<AppState> => {
    ...
    return {
        ...
        documentCategories: ['Handleiding', 'Schema', 'Rapportage'],
        ...
        serverApiKey: meta.adminPassword, 
...
export const setStore = async (state: AppState) => {
    ...
    await Promise.all([
        ...
        saveTable(KEYS.SETTINGS_SYSTEM, state.systemSettings),
    ...
    await saveTable(KEYS.METADATA, {
        ...
        adminPassword: state.adminPassword || state.serverApiKey,
